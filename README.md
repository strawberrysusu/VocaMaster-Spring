...
영어 · 일본어 단어를 등록(한 장씩 또는 일괄 붙여넣기)해 **플래시카드 · 퀴즈(4~6지선다) · 타이핑**으로 학습하고,
...
Quizlet을 쓰다가 4지선다 퀴즈가 유료로 바뀌고, 광고와 이용 횟수 제한이 붙는 걸 보며
**"매일 쓰는 도구라면 직접 만드는 게 낫겠다"**고 생각했습니다.
...
| 홈 — 오늘의 복습 · 라이트너 사다리 | 덱 — 요미가나 · 일괄 가져오기 |
|---|---|
| ![홈](docs/images/home.png) | ![덱 상세](docs/images/deck.png) |

| 퀴즈 — 서버 채점 · 오답만 재시험 | 통계 — 28일 활동 · 덱별 진행률 |
|---|---|
| ![퀴즈](docs/images/quiz.png) | ![통계](docs/images/stats.png) |
...
| 학습 3모드 | 플래시카드(안다/모른다) · 4~6지선다 퀴즈 세션(선택지 수 선택 · 서버 채점 · 정답 마스킹 · **이번 오답만 재시험**) · 타이핑(쉼표 복수 정답) |
